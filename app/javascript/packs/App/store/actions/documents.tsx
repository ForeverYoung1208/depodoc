...
function postDocumentOk(
	document:documentType, 
	formikActions:FormikHelpers<any>):{type:actionsTypesType, documents:Array<documentType>} 
{
...
function postDocumentError(
	error:string, 
	formikActions:FormikHelpers<any>):{type:actionsTypesType, error:string} 
{
